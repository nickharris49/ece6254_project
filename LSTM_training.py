...
if __name__ == "__main__":
    ...
    train_x, test_x, train_y, test_y = generate_lstm_windows_multiple_subs(WINDOW_SIZE, features, output_feature, subjects_ankle_base)
    ...
    train(net, trainloader, testloader, epochs=200, batch_size=BATCH_SIZE, lr=0.005)