...
datadir = "./DATASET/"
X_raw = np.load(datadir + "feature_vector_full_normalized_1.npy")
if X_raw.shape[0] == 4:
...
y_raw = np.load(datadir + "y_normalized_1.npy").reshape(-1)
...
model = Sequential(
    [
        Input(shape=(window_size, 3)),  # 3 not 4 because I dropped 5k reactance
